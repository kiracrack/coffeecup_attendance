...
Module Connection
    ...
    Public Function OpenMysqlConnection() As Boolean
        ...
        Catch errMYSQL As MySqlException
            ...
            MessageBox.Show("Error Message: " & errMYSQL.Message & vbCrLf, _
                             "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        Catch errMS As Exception
            MessageBox.Show("Error Message: " & errMS.Message & vbCrLf, _
                              "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Function GetLocalIPAddress() As String
        ...
        LocalIP = System.Net.Dns.GetHostByName(tmpHostName).AddressList(0).ToString()
        Return LocalIP
    End Function
End Module
